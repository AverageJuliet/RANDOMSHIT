...
ASCII_CHARS = ["@", "#", "S", "%", "?", "*", "+", ";", ":", ",", " ","$","!","&"] #added symbols for improved encoding 5/5/2023
frame_size = 150
...
#code written by AverageJuliet/minecraft420github12123 on github
#odds are you are wondering why the FUCK i made this
#i dunno buddy if i am going to be honest with you    
